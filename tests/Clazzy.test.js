...
module.exports =
{
	'creating a class with no definition' : function (test)
	{
		// Act
	...
	'creating a class with a constructor using the `initialize` definition' : function (test)
	{
		// Act
		var Foo = Clazzy.create(
		{
	...
	'creating a class with instance members' : function (test)
	{
		// Act
		var Foo = Clazzy.create(
		{
	...
	'creating a class with class members using the `static` definition' : function (test)
	{
		// Act
		var Foo = Clazzy.create(
		{
	...
	'creating a class that extends a class using the `extend` definition' : function (test)
	{
		// Act
		var Foo = Clazzy.create(
		{
	...
	'creating a class that includes a class using the `include` definition' : function (test)
	{
		// Act
		var Foo = Clazzy.create(
		{
	...
	'the super method' : function (test)
	{
		// Act
		var Foo = Clazzy.create(
		{
	...
	'order of precedence for inherited, included and current methods' : function (test)
	{
		// Act
		var Foo = Clazzy.create(
		{
